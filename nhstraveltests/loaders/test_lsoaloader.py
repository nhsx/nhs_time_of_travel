...
from nhstravel.loaders.lsoaloader import read_lsoa_objects_england, load_lsoa_objects_for_area_england
...
class MyTestCase(unittest.TestCase):
    def test_read_lsoa_objects_england(self):
        ...
        expected = pd.DataFrame.from_dict({
            ...
            "GlobalID": pd.Series("5DAF269C-8A7B-48BF-A941-5F56F36D53A7", dtype="string"),
        })
