...
def generate_route_maps(
    ...
    route_maps = []
    for site, target_address, target_coords in zip(
        site_names, list_of_target_addresses, list_of_target_coords
    ):
...
def mclp_main(region, list_of_target_addresses):
    ...
    list_of_target_nodes, list_of_target_coords = get_target_nodes(
        G, list_of_target_addresses
    )
    ...
    route_maps = generate_route_maps(
        G,
        target_to_node_routes,
        site_names,
        list_of_target_addresses,
